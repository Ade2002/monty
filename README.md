...
chmod u+x monty.c && git add --chmod=+x pint.c && git commit -m 'Task 01 The opcode pint prints the value at the top of the stack, followed by a new line. pint.c' && git push
